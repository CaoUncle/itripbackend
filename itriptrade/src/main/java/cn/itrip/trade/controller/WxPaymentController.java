...
public class WxPaymentController {
    ...
    public Dto createCode(@PathVariable String orderNo) {
        try {
            ...
            //异步通知的URL地址。
            data.put("notify_url", "http://cpfitrip.free.idcfengye.com/trade/api/wx/notify");
            data.put("trade_type", "NATIVE");
            data.put("product_id", "12");
            data.put("appid", "wxab8acb865bb1637e");//appid暂时用的是测试用的appid
            ...
            if (resultMap.get("return_code").equals("SUCCESS") && resultMap.get("result_code").equals("SUCCESS")) {
                ...
                return DtoUtil.returnSuccess("获取成功！", resultMap.get("code_url"));
            } else {
